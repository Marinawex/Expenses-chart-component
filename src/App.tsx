...
console.log((currentDay))
  ...
  return (
    <>
<div className='balance'> <div className='h2'><h2>My balance</h2> <div className='total-balance'>{`$${balance}`}</div> </div><div className='circles-container'><div className='circle white'></div> <div className='circle black'></div></div>
  </div>
 
<div className='spending'>
  
  <h1>Spending - Last 7 days</h1>
  <div className='spending-week' >
 {spendingByDaysList}
  </div>
